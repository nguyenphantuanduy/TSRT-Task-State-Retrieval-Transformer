...
MAX_STEPS = TOTAL_SAMPLES // GRAD_ACCUM_STEPS
...
class HotpotDataset(IterableDataset):
    ...
    def __iter__(self):
        ...
        for sample in self.dataset:
            ...
            # phần model nhận vào trước answer
            prompt = (
                f"Question: {sample['question']}\n\n"
                f"Context:\n{context}\n\n"
                f"Answer:"
            ...
            if count % 1000 == 0:
                ...
                print(
                    f"Processed {count}/{TOTAL_SAMPLES}"
                )
