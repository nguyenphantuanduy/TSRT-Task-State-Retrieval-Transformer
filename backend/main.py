...
# print("=" * 80)
# print("Mini TSRT Config")
# print("=" * 80)

# print("num_hidden_layers  :", config.num_hidden_layers)
# print("num_decoder_layers :", config.num_decoder_layers)
# print("num_encoder_layers :", config.num_encoder_layers)
# print("num_tsrt_layers    :", config.num_tsrt_layers)

# print()
# print("layer_types length  :", len(config.layer_types))
