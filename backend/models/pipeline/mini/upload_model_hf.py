...
def upload_mini_tsrt():
    """
    Upload Mini TSRT model weights and configuration
    to the `mini/` subfolder of the Hugging Face Hub
    repository.
    """
    ...
    if not os.path.exists(LOCAL_FOLDER):
        raise FileNotFoundError(
            ...
            "Hãy đảm bảo bạn đã build Mini TSRT "
            "thành công."
        )
    ...
    print(
        "\nBắt đầu upload Mini TSRT "
        "lên Hugging Face Hub..."
    )
